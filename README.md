...
- [VIDEO-RENAMING.md](VIDEO-RENAMING.md) — Mandatory descriptive naming schema and context requests for all video processing output.
- [DISCORD-FIRE-EMOJI.md](DISCORD-FIRE-EMOJI.md) — How to interpret the 🔥 reaction.
